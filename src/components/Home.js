        ...
        >
            <div className="flex flex-col justify-center items-center py-5 text-center">
                <motion.div
                    ...
                    <img src={process.env.PUBLIC_URL + '/images/user.jpg'}  className="w-full"/>
                </motion.div>
                <h1 className="mt-5 mb-1 font-header text-4xl">Dumindu Lakshan Bandara</h1>
                ...
                >
                    <a href="https://drive.google.com/file/d/1MGgmMzpfK63BoFhgxaUMF1ndklsAcf3r/view?usp=sharing" target="_blank">Download Resume</a>
                </motion.button>
            </div>
        </motion.div>
    );
