  ...
  return (
    <motion.div variants={pageLoaded} initial="hidden" animate="visible">
      <motion.div
        ...
        className="my-6"
      >
        <h1 className="text-[#0000005b] text-[3.4rem] md:text-[5rem] lg:text-[10rem] text-center font-header">
          Contact Me.
        </h1>
      </motion.div>
          ...
          {send == false ? (
            <form onSubmit={sendEmail}>
              <div className="mb-5">
                ...
                <input
                  className="bg-gray-200 py-3 px-4 mt-2 w-full rounded-xl placeholder:text-gray-600"
                  type="email"
                  name="email"
              ...
              <div>
                ...
                <textarea
                  className="bg-gray-200 py-3 px-4 mt-2 w-full h-[200px] rounded-xl placeholder:text-gray-600"
                  name="message"
              ...
              <div className="flex lg:justify-start justify-center">
                <motion.button
                  ...
                  className="my-4 px-7 py-3 bg-black text-white rounded-xl"
                  type="submit"
                >
                  Send
                </motion.button>
