      ...
      >
        ...
        <div className="px-[40px] flex flex-col justify-center text-left lg:col-span-3 p-5 rounded-3xl drop-shadow-lg bg-white mb-12">
          ...
          <p className="text-lg font-body leading-7 font-semibold space-x-2">
            I'm Dumindu Lakshan Bandara, currently pursuing a BSc(Hons) in Information Technology specializing in Information Technology at SLIIT, Malabe. As an ambitious individual, I am always striving to improve and grow. My approach towards work is honest and I value teamwork, ensuring that everyone's opinions are heard. I take a thoughtful approach to implementing programs, carefully considering their effectiveness. I am committed to achieving my goals in a timely and accurate manner and strive to maintain a positive outlook in all situations.
          </p>
        </div>
